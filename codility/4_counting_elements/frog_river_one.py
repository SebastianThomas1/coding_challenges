...
# FrogRiverOne
#
# Find the earliest time when a frog can jump to the other side of a
# river.
#
...
if __name__ == '__main__':
    ...
    print(solution(5, [1, 3, 1, 4, 2, 3, 5]))  # 6
    print(solution(5, [1, 3, 1, 4, 2, 3]))  # -1
